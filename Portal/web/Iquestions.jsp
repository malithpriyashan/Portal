                    ...
                    <div class="box-panel">
                        ...
                        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 3px dotted #F80000;padding-top: 25px; width: 1000px"><ul><li><a style="color: black;" href="Ianswerpage.jsp?id=<%=rs.getString("id")%>" ><%= rs.getString("title") %></a></li></ul></td>
            ...
            <div class="container-fluid" >
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <!-- form login -->
                        <form class="margin-top-40" action="Addquestion" method="post" style="margin-left: 30px;" >
